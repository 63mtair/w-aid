                        ...
                        <div className="flex items-center">
                          ...
                          <div>
                            ...
                            <div className="text-sm text-gray-500">
                              تاريخ التسجيل: {new Date(organization.createdAt).toLocaleDateString('en-CA')}
                            </div>
                          </div>
                        </div>
                      </td>
          ...
          <div className="bg-white rounded-2xl p-6 w-full max-w-2xl mx-4 max-h-[90vh] overflow-y-auto">
            ...
            {modalType === 'view' && selectedOrganization && (
              <div className="p-6">
                ...
                <h4 className="text-lg font-bold">تفاصيل المؤسسة: {selectedOrganization.name}</h4>
                <p>النوع: {selectedOrganization.type}</p>
                <p>الموقع: {selectedOrganization.location}</p>
                <p>شخص الاتصال: {selectedOrganization.contactPerson}</p>
          ...
          <div className="p-6 space-y-6">
            <div className="bg-blue-50 p-4 rounded-xl border border-blue-200">
              ...
              <div className="grid md:grid-cols-2 gap-4 text-sm">
                <div>
                  <span className="text-blue-700">إجمالي المؤسسات:</span>
                  <span className="font-medium text-blue-900 mr-2">{totalOrganizations}</span>
                </div>
                <div>
                  <span className="text-blue-700">المفلترة للتصدير:</span>
                  <span className="font-medium text-blue-900 mr-2">{filteredOrganizations.length}</span>
                </div>
                <div>
                  <span className="text-blue-700">نشطة:</span>
                  <span className="font-medium text-green-600 mr-2">{activeOrganizations}</span>
                </div>
                <div>
                  <span className="text-blue-700">معلقة:</span>
                  <span className="font-medium text-orange-600 mr-2">{pendingOrganizations}</span>
                </div>
              </div>
            </div>
            ...
            <div className="flex space-x-3 space-x-reverse justify-end pt-4">
              ...
              >
                تصدير ({filteredOrganizations.length} مؤسسة)
              </Button>
            </div>
          </div>
        </Modal>
