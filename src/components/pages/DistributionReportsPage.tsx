...
import { BarChart3, Download, Calendar, Filter, TrendingUp, Users, Package, CheckCircle, Clock, AlertTriangle, Star, Award, MapPin, Activity, PieChart, LineChart, Truck, Eye, Edit, RefreshCw } from 'lucide-react';
...
export default function DistributionReportsPage() {
  ...
  const tabs = [
    ...
    { id: 'comprehensive', name: 'التقارير الشاملة', icon: Activity }
  ];
  ...
  const handleExportReport = () => {
    ...
    alert('تم تصدير تقرير التوزيع بنجاح');
  };
      ...
      <Card className="bg-blue-50 border-blue-200" padding="sm">
        <div className="flex items-center space-x-2 space-x-reverse text-blue-600">
          ...
          <span className="text-sm font-medium">
            البيانات الوهمية محملة - تقارير التوزيع والتقارير الشاملة
          </span>
        </div>
      </Card>
      ...
      {activeTab === 'overview' && (
        <div className="space-y-6">
          <div className="flex items-center justify-between">
            <div>
              <h3 className="text-xl font-bold text-gray-900">نظرة عامة على التوزيع</h3>
              <p className="text-gray-600 mt-1">ملخص شامل لعمليات التوزيع والأداء</p>
            </div>
            <Button variant="primary" icon={Download} iconPosition="right" onClick={handleExportReport}>
              تصدير التقرير
            </Button>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <Card className="bg-green-50">
              <div className="text-center">
                ...
                <p className="text-xs text-green-700 mt-1">+5% من الشهر الماضي</p>
              </div>
            </Card>
            ...
            <Card className="bg-blue-50">
              <div className="text-center">
                ...
                <p className="text-sm text-blue-600">متوسط وقت التسليم</p>
                <p className="text-2xl font-bold text-blue-900">2.3</p>
                <p className="text-xs text-blue-700 mt-1">ساعة</p>
              </div>
            </Card>
            ...
            <Card className="bg-purple-50">
              <div className="text-center">
                ...
                <p className="text-sm text-purple-600">إجمالي الطرود</p>
                <p className="text-2xl font-bold text-purple-900">{stats.totalPackages}</p>
                <p className="text-xs text-purple-700 mt-1">{stats.deliveredPackages} مسلم</p>
              </div>
            </Card>
          </div>
          ...
          <Card>
            <h4 className="text-lg font-semibold text-gray-900 mb-4">آخر أنشطة التوزيع</h4>
            <div className="space-y-3">
              <div className="flex items-center justify-between p-3 bg-green-50 rounded-lg border border-green-200">
                <div className="flex items-center space-x-3 space-x-reverse">
                  <CheckCircle className="w-5 h-5 text-green-600" />
                  <span className="text-sm font-medium text-gray-900">تم تسليم 23 طرد في خان يونس</span>
                </div>
              ...
              <div className="flex items-center justify-between p-3 bg-blue-50 rounded-lg border border-blue-200">
                <div className="flex items-center space-x-3 space-x-reverse">
                  ...
                  <span className="text-sm font-medium text-gray-900">بدء دفعة توزيع جديدة - 150 طرد</span>
                </div>
              ...
              <div className="flex items-center justify-between p-3 bg-orange-50 rounded-lg border border-orange-200">
                <div className="flex items-center space-x-3 space-x-reverse">
                  ...
                  <span className="text-sm font-medium text-gray-900">تأخير في دفعة التوزيع - منطقة رفح</span>
                </div>
        ...
        <Card className="p-8">
          <div className="text-center">
            <div className="bg-gray-100 rounded-xl p-8 mb-4">
              ...
              <p className="text-gray-600">دفعات التوزيع</p>
              <p className="text-sm text-gray-500 mt-2">سيتم تطوير هذا القسم لعرض دفعات التوزيع المختلفة</p>
            </div>
        ...
        <Card className="p-8">
          <div className="text-center">
            <div className="bg-gray-100 rounded-xl p-8 mb-4">
              ...
              <p className="text-gray-600">تقارير الأداء</p>
              <p className="text-sm text-gray-500 mt-2">سيتم تطوير هذا القسم لعرض تقارير أداء مفصلة</p>
            </div>
            <Button variant="primary">
              عرض التقارير
            </Button>
        ...
        <Card className="p-8">
          <div className="text-center">
            <div className="bg-gray-100 rounded-xl p-8 mb-4">
              ...
              <p className="text-gray-600">التوزيع الجغرافي</p>
              <p className="text-sm text-gray-500 mt-2">سيتم تطوير هذا القسم لعرض التوزيع الجغرافي</p>
            </div>
            <Button variant="primary">
              عرض الخريطة
            </Button>
